...
# Optional: If you still have issues with SSL
# os.environ['REQUESTS_CA_BUNDLE'] = r'C:\path\to\combined_cert.pem'
...
MODEL_PATH = r"C:\Users\wfhq_lpham\Downloads\docs"
...
timestamp_col_idx = find_header_index(headers, "Timestamp") + 1
email_col_idx = find_header_index(headers, "Email") + 1
